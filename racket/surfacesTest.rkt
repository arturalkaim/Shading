...
(let* ([p0 (xyz 0.0 0.0 0.0)]
  ...
  ;(polygon-surface (list p0 p1 p2 p3) 0.0 1.0 1.0)
  (line (list p0 p1 p2 p3) 0.0 0.0 1.0)
  (displayln (reg-line p0 7.0 4.0 4.0 p1 0.0 0.0 0.0 1.0))
...
(let* ([p0 (xyz 0.0 5.0 0.0)]
       ...
       [a2 (* (/ pi 6) 7)]
       [a3 (- (/ pi 3))])
  (irregularPyramid3 p0 p1 35.0 a1 37.0 a2 37.0 a3 0.0 0.7 0.0))

;(point (u0) 1.0 1.0 0.0)
