...
#define FloatInfinity   ((float)(_HUGE_ENUF * _HUGE_ENUF))

//#define   FloatInfinity std::numeric_limits<float>::max()
...
namespace sasmaster{
	...
	void TrackballControls::MouseDown(int button, int action, int mods,int xpos,int ypos){
		if (!m_enabled) { return; }
